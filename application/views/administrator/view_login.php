...
<html>
  <head>
    ...
    <meta name="author" content="manadokota.go.id">
      ...
      <div class="login-box-body">
        ...
        <?php 
          if ($this->input->post('email')!=''){
            ...
            echo form_open('Lorpo/index'); 
        ?>
          <div class="form-group has-feedback">
            <input type="text" class="form-control" name='a' placeholder="Username" required autocomplete="off">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
                  <?php 
                      ...
                      echo form_open('Lorpo/lupapassword',$attributes); 
                  ?>

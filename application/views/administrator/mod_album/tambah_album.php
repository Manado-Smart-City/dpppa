...
<!-- Order Form -->
 <div class="col-xs-12">  
    <div  class="sky-form">
        ...
        <h1 class="pull-left">Tambah Album</h1>
    ...
    <!--=== End Breadcrumbs ===-->
           <?php  
              echo form_open_multipart('lorpo/tambah_album'); ?>
            <fieldset>
              <div class="row">
                ...
                <section class="col col-4">    
                  ...
                  <div class="button"><input type="file" name="cover" multiple onchange="this.parentNode.nextSibling.value = this.value">Pilih Gambar</div><input type="text" name="cover">
                </label>
              ...
              <div class="row">
                ...
                <label class="label">Keterangan&nbsp;<i>*</i></label>            
                  <textarea id="picture_description" class="form-control mceNoEditor" name="ketalbum" rows="5"></textarea>
                </section>
              </div>
